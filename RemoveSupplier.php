...
<div class="container">
    ...
    <div class="small_con">
        ...
        <form method="POST" action="RemoveSupplier.php">
            <h3 id="selectedOption"><b>Remove Supplier</b></h3>

            <br>
            <label for="sin"><b>Phone Number&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>

            <input type="text" placeholder="Enter Phone" name="phone" required>
            <br>


            <input type="submit" value="Remove" name="removeSupplier">
