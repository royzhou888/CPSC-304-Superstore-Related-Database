...
<div class="container">
    ...
    <div class="small_con">
        ...
        <form method="POST" action="UpdateSupplier.php">
            <h3 id="selectedOption"><b>Update Supplier</b></h3>
            <p><label for="sin"><b>Phone&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
                <input type="text" placeholder="Enter Phone (required)" name="phone" >
                <br>
            </p>

            <label for="sname"><b>New Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>

            <input type="text" placeholder="Enter new Name" name="newName" >
            <br>

            <label for="address"><b>New Address&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter new Address" name="newAddress" >
            <br>
            <label for="status"><b>New Status&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter New Status(t/f)" name="newStatus">
            <br>
