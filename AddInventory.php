...
<div class="container">
    ...
    <div class="small_con">
        ...
        <form method="POST" action="AddInventory.php">
            <h3 id="selectedOption"><b>Add Inventory</b></h3>

            <label for="ename"><b>Inventory Name&nbsp</b></label>

            <input type="text" placeholder="Enter Name" name="name" required>
            <br>
            <label for="sin"><b>Part Number&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter Part Number" name="part" required>
            <br>
            <label for="pos"><b>Supplier&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter Supplier" name="supplier" required>
            <br>
            <label for="quantity"><b>Quantity&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter Quantity" name="quantity">
            <br>
            <label for="price"><b>Price&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
