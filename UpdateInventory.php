...
<div class="container">
    ...
    <div class="small_con">
        ...
        <form method="POST" action="UpdateInventory.php">
            <h3 id="selectedOption"><b>Update Inventory</b></h3>
            <p><label for="sin"><b>PartNumber(required)&nbsp</b></label>
                <input type="text" placeholder="Enter Part Number" name="part" >

            </p>

            <label for="ename"><b>New Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>

            <input type="text" placeholder="Enter new Name" name="newName" >
            <br>

            <label for="pos"><b>New Supplier&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter new Suplier" name="newSupplier" >
            <br>
            <label for="rating"><b>New Quantity&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter New Quantity" name="newQuantity">
            <br>
