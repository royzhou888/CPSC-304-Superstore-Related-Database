...
<div class="container">
    ...
    <div class="small_con">
        ...
        <form method="POST" action="FindEmployee.php">
            <h3 id="selectedOption"><b>Find Employee (please all use small case)</b></h3>

            <label for="ename"><b>By Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>

            <input type="text" placeholder="Enter Name" name="name" >
            <br>
            <label for="sin"><b>By SIN&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter SIN" name="sin" >
            <br>
            <label for="pos"><b>By Position&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter Position" name="position" >
            <br>
            <label for="rating"><b>By Rating&nbsp&nbsp&nbsp&nbsp&nbsp</b></label>
            <input type="text" placeholder="Enter Rating" name="rating">
            <br>
            <label for="managerSin"><b>By Manager&nbsp</b></label>
